...
import pl.edu.pw.auth.security.filter.*;
...
import pl.edu.pw.auth.service.devices.DevicesServiceImpl;
...
//        desktop app processing
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "secure-bank-web-client:80"));
